...
class CommandsNames:
    ...
    COMMANDS = (f'**Список доступных команд:**\n'
                ...
                f'\n'
                f'- `/autorole on-join (@role1, @role2, ...) - автоматически назначать роли зашедшим на сервер\n'
                f'\n'
                ...
                f'\n'
                f'- /join [voice channel id] - пригласить бота в голосовой канал где сидит пользователь (если ID не указан) или в указанный голосовой канал.\n'
